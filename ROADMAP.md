...
- [x] **Адверсариальное ревью нового/рискового кода перед релизом.** (прогон 2026-07)
  ...
  **2 бага**: RIS не сбрасывал флаг-стек (после `tput reset` плейн-ввод
  ...
  Пофикшено (`cbc1453`). Итог двух батчей: 6 багов (2 из них
  security/privacy: утечка секретов + недоверенный OOM) в 7 зонах, все
  с тестами. Вывод: релиз-готовность существенно повышена.
  Сбросить в `[ ]` перед следующим релизом.
